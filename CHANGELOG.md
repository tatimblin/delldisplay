...
- add a Claude Code plugin and marketplace ([#3](https://github.com/tatimblin/delldisplay/pull/3))
- add delldisplay mcp, an MCP server for AI agents ([#5](https://github.com/tatimblin/delldisplay/pull/5))
